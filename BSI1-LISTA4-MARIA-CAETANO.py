...
def fibonacci(n):
    ...
    contador = 0
    while contador < n:
        # se a lista estiver vazia ou com um elemento, adicionar 1
        if len(fibonacci) <= 1:
            fibonacci.append(1)
        else:
            # Ademais, usar a escala para adicionar outros itens
